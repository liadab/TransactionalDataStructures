...
public class Main {
	...
	static Integer N_INIT_LIST = 1000;
	...
	{
		public Task(OP task_type, Integer key, String val)
		{			
	...
	static Task get_random_task(OP task_op)
	{
	    ...
	    {
		    val += alphanum.charAt(rand.nextInt(alphanum.length() - 1));
		    val += alphanum.charAt(rand.nextInt(alphanum.length() - 1));
		    val += alphanum.charAt(rand.nextInt(alphanum.length() - 1));
	    }
							  ...
							  double running_time_sec)
	{
		...
		System.out.println("total LL size: " + total_linked_list_size);
	...
	public static void main(String[] args)     
	{
	    ...
	    System.out.println("linked list size: " + init_LL_size);
	    linked_list.printLinkedListSize();
	    ...
	    print_results(workers, init_LL_size, n_threads, elapsed_time);
	    linked_list.printLinkedListSize();
	}		
}
